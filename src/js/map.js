    ...
    drawMap(world) {
        ...
        view
            ...
            .on('click', function() {
                ...
                //         let newdata=data[i];
                //
                //         if (newdata.teams_iso.includes(country))
                //         {
                //             let index=newdata.teams_iso.indexOf(country);
                //             let heading = d3.select("#country");
                //             heading.selectAll("text").remove();
                //
                //             heading
                //                 .append("text")
                //                 .text(" "+newdata.teams_names[index+1])
                //             if(newdata.winner==newdata.teams_names[index+1]) {
                //                 worldcups.push(newdata.EDITION+"-Winner");
                //             }
                //             else if(newdata.runner_up==newdata.teams_names[index+1]){
                //                 worldcups.push(newdata.EDITION+"-Runner-Up");
                //
                //             }
                //             else worldcups.push(newdata.EDITION);
                //
                //
                //
                //         }
                ...
                //     }
                // }
                // barChart.infoPanel.updateCountryPanel(worldcups);
            });
